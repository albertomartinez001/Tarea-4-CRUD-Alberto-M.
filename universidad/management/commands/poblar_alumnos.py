...
from universidad.Models.alumno import Alumno  # Importante: verifica las mayúsculas/minúsculas de tus carpetas
    ...
    def handle(self, *args, **kwargs):
        ...
        for i in range(10000):
            ...
            nuevo_alumno = Alumno(
                ...
                phone=f"1234{i:04d}", # Genera un número de relleno
                gender=random.choice(generos),
                birth_date=date(2000, 1, 1), # Fecha fija para simplificar
                is_active=True
            )
        ...
        try:
            Alumno.objects.bulk_create(alumnos_lista)
